...
namespace ControlRobotApi.Services
{
    public class rightArmsWristService
    {
        ...
        {
            if ((newStateWrist.stateRightWrist == (_state.stateRightWrist + 1) || newStateWrist.stateRightWrist == (_state.stateRightWrist - 1)) && newStateWrist.stateRightWrist < 8 && newStateWrist.stateRightWrist > 0)
            {
